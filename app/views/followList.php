...
<main class="container mb-5">
    ...
    <div class="row">
        ...
        <?php else: ?>
            ...
            <div class="my-3 row">
                <a href="followList.php?user_id=<?php echo $current_user['id']; ?>" class="col-6 block">
                ...
                <a href="follwedList.php?user_id=<?php echo $current_user['id']; ?>" class="col-6 block count_btn">
